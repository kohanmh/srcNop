...
namespace Nop.Services.Catalog
{
    ...
    public partial class PriceFormatter : IPriceFormatter
    {
        ...
        {
            // var sepratPrice =Convert.ToDecimal(String.Format("{0,12:#.00000}", price));
            //var sepratPrice = price.ToString("C2"); Rials
            var sepratPrice = price.ToString("N");
            //var dec = Convert.ToDecimal(sepratPrice);
